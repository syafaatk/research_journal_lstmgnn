...
- **Produk level-item:** masker TIDAK melonjak. Yang naik justru IV Catheter x21,9, Infusion Set x6,5, IV Cannula x5,9 (pola belanja umum Sep-Okt, bukan respons asap). Karhutla BUKAN pemicu signifikan penjualan di data ini.
  - **Verifikasi satuan (28 Agu 2026, `scripts/masker_karhutla_analysis.py`):** masker dijual campur satuan Box dan Pcs (1 box N95 isi ~20 pcs), sehingga qty mentah antar satuan TIDAK bisa dijumlahkan langsung. Setelah dipisah per satuan, temuan negatif justru makin kuat: saat karhutla (Agu-Sep 2023) qty Box = 421 vs baseline 887/bln (ratio 0,47), qty Pcs = 0 vs 1.634/bln; nilai Box = 8,0 jt vs 64,4 jt/bln (ratio 0,12). Puncak masker sebenarnya di masa COVID 2020-2021 (Sep 2020 Box 5.858; Okt 2021 Pcs 63.540), bukan karhutla.
